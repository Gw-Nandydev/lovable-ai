...
export default function Header({
  ...
  return (
    <div className="flex h-14 items-center justify-between border-b border-white/10 bg-[#0c0c0c] px-6 text-sm shadow-sm">
        ...
        {view === 'preview' && (
          <div className="relative">
            <select
              ...
              className="appearance-none pl-3 pr-8 py-1.5 rounded-md border border-white/10 bg-[#1a1a1a] text-white text-sm shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
            >
            ...
            <div className="pointer-events-none absolute right-2 top-2 text-white/40 text-xs">
              ▼
            </div>
          </div>
        )}
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="relative" ref={supabaseRef}>
          ...
          {showSupabase && (
            <div className="absolute right-0 mt-2 w-64 rounded bg-[#1a1a1a] border border-white/10 p-4 text-xs shadow-lg z-10">
        ...
        <div className="relative" ref={inviteRef}>
          ...
          {showInvite && (
            <div className="absolute right-0 mt-2 w-72 rounded bg-[#1a1a1a] border border-white/10 p-4 text-xs shadow-lg z-10">
            ...
            <div className="absolute right-0 mt-2 w-64 rounded bg-[#1a1a1a] border border-white/10 p-4 text-xs shadow-lg z-10">
              ...
              <div className="flex justify-between mt-2">
                ...
                <button
                  ...
                  className="bg-blue-600 text-white text-[11px] px-3 py-[3px] rounded hover:bg-blue-700"
                >
